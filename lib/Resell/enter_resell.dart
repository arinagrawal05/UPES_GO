...
class EnterResell extends StatefulWidget {
  ResellModel? model;
  EnterResell({super.key, required this.model});

  @override
  State<EnterResell> createState() => _EnterResellState();
}

class _EnterResellState extends State<EnterResell> {
  ...
  void initState() {
    ...
    if (widget.model != null) {
      name.text = widget.model!.productImg;
      imageUrll = widget.model!.productImg;
